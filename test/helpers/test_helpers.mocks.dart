...
// in pataya_ending_card/test/helpers/test_helpers.dart.
...
import 'package:pataya_ending_card/services/e_card_service.dart' as _i7;
...
/// A class which mocks [ECardService].
///
/// See the documentation for Mockito's code generation for more information.
class MockECardService extends _i1.Mock implements _i7.ECardService {
  @override
  ...
  _i2.Uuid get uuid => (super.noSuchMethod(
        ...
        returnValueForMissingStub: _FakeUuid_0(
          this,
          Invocation.getter(#uuid),
        ),
      ) as _i2.Uuid);
  @override
  List<_i8.ECard> get cards => (super.noSuchMethod(
        Invocation.getter(#cards),
        returnValue: <_i8.ECard>[],
        returnValueForMissingStub: <_i8.ECard>[],
      ) as List<_i8.ECard>);
  @override
  ...
  @override
  _i5.Future<dynamic> create(_i8.ECard? card) => (super.noSuchMethod(
        Invocation.method(
          #create,
          [card],
        ),
  ...
  @override
  _i5.Future<dynamic> update(_i8.ECard? card) => (super.noSuchMethod(
        Invocation.method(
          #update,
          [card],
        ),
  ...
  @override
  _i5.Future<dynamic> delete(String? id) => (super.noSuchMethod(
        Invocation.method(
          #delete,
          [id],
        ),
