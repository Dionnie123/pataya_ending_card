...
class ScoreDialog extends StatelessWidget {
  ...
  const ScoreDialog({Key? key, required this.request, required this.completer})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<ScoreDialogViewModel>.reactive(
        viewModelBuilder: () => locator<ScoreDialogViewModel>(),
        onViewModelReady: (viewModel) {
          viewModel.initForm(request.data['card'],
                          ...
                          children: [
                            EzButton.elevated(
                              ...
                              onTap: () {
                                completer.call(
                                  DialogResponse(
                                      data: viewModel.formModel.model),
                                );
                              },
                            ),
                            vSpaceSmall,
